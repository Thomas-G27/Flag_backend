Do $$
    DECLARE _CONTINENT_1 int := NEXTVAL('continent_id_seq');
    DECLARE _PAYS_1 int := NEXTVAL('pays_id_seq');
    DECLARE _LANGUAGE_1 int := NEXTVAL('languages_id_seq');
    DECLARE _USER_1 int := NEXTVAL('utilisateur_user_id_seq');
    DECLARE _PARTIE_1 int := NEXTVAL('partie_partie_id_seq
